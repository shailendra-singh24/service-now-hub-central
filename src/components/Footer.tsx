    ...
    <footer className="bg-servicenow-dark text-white">
      <div className="max-w-7xl mx-auto pt-12 pb-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1 w-80 ">
            <div className="flex items-center gap-2 mb-4">
              <div className="bg-red p-1 hover:scale-110 transition-transform duration-300">
                <img
              ...
              <h2 className="text-lg font-bold">BharatNow Solutions</h2>
            </div>
            <p className="text-gray-300 mb-4 w-72">
              Delivering exceptional ServiceNow solutions to transform your
              business processes.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-4 md:mb-0">
              <p className="text-gray-400">
                &copy; {new Date().getFullYear()} BharatNow Solutions. All
                rights reserved.
              </p>
            </div>
